...
Для подробностей читайте `man dmidecode`.

## DMI

Название утилиты `dmidecode`. состоит из двух частей. 

    DMI + decode

DMI (Desktop Management Interface) — интерфейс программирования приложений 
(API), позволяющий программному обеспечению собирать данные 
...
Более подробную информацию про процессорный кеш можно получить так:
