...
топологии реальной Вашей сети

![Изображение. Zenmap: топология локальной сети](images/zenmap-lhst-ltopo.png "zenmap: топология локальной сети")


Аналогичное изображение для сети лабораторного класса выглядит так:
