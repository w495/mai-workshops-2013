 ...
 *      квадратной матрицы порядка NxN (-1 < N < 101), из целых чисел, 
 *      вводимой из стандартного входного текстового файла (stdin).
 *      Результат программы выводится на стандартный поток вывода (stdout).
 *      В данном варианте требуется выполнить поворот матрицы на 90 градусов 
 *      против часовой стрелки. Формат ввода имеет вид:
 * 
 *          {N}
 *          {x_11}  {x_21}  ... {x_1N} 
 *          {x_12}  {x_22}  ... {x_2N}
